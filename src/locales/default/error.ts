export default {
  ...
  response: {
    ...
    SubscriptionLimited: '您的积分已用完，请升级计划获得更多积分或等待下个周期重置。',
    SubscriptionRequired: '您需要订阅才能使用此功能。请订阅计划获得访问权限。',
  },
  stt: {
  ...
  upload: {
    ...
    storageNotEnough: '存储空间不足，可用空间 {{available}}MB，需要 {{required}}MB，请先释放空间或升级方案',
